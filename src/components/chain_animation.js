...
import { Global, Container, Item } from './styles_animation'
...
export default function ChainAnimation() {
    ...
    useChain(open ? [springRef, transRef] : [transRef, springRef], [0, open ? 0.1 : 0.1])
  ...
  render(<ChainAnimation />, document.getElementById('root'))
